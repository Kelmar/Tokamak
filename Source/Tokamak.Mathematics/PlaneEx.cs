...
namespace Tokamak.Mathematics
{
    ...
    public static class PlaneEx
    {
        ...
        {
            /// <summary>
            /// Get the distance from the plane to the supplied vector.
            /// </summary>
            ...
            /// </summary>
            /// <remarks>
            /// The vector case is the same as the sphere test, but we consider it to
            ...
            /// </list>
            /// </returns>
            public Boundary WhichSide(in Vector3 location, float radius = MathX.FUZ)
            {
            ...
            public bool RayTest(in Vector3 start, in Vector3 end, out float t)
            {
